    ...
    for (size_t vl; n > 0; n -= vl, outPtr += vl * 2, inPtr += vl * 2)
        {
            ...
            inRealVal = __riscv_vmin_vf_f32m4(inRealVal, (float) 32767, vl);
            inRealVal = __riscv_vmax_vf_f32m4(inRealVal, (float) -32768, vl);
            inImagVal = __riscv_vmin_vf_f32m4(inImagVal, (float) 32767, vl);
            inImagVal = __riscv_vmax_vf_f32m4(inImagVal, (float) -32768, vl);
